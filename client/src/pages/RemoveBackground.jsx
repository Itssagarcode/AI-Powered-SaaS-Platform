...
import { Eraser, EraserIcon, Hash, Sparkles} from 'lucide-react'
...
const RemoveBackground = () => {
  ...
  <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
          ...
          <Sparkles className='w-6 text-[#ff7938]'/>
          <h1 className='text-xl font-semibold'>Background Removal</h1>
        </div>
        <p className='mt-6 text-sm font-medium'>Upoad image</p>
  ...
  <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96'>
    ...
    <div className='flex-1 flex justify-center items-center '>
        <div className='text-sm flex flex-col items-center gap-5 text-gray-400'>
            ...
            <p>Upload a image and click "Remove Backgtound" to get started</p>
        </div>
        </div>        
          ) : (
